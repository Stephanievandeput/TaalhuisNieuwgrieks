...
public class LessonNineActivity extends AppCompatActivity {
    ...
    private void intentGRNL() {
        ...
        Intent overhoorIntent = new Intent(LessonNineActivity.this, TestActivityLessonNineGRNL.class);
    ...
    private void intentNLGR() {
        // Create a new intent to open the {@link NumbersActivity}
        Intent overhoorIntent = new Intent(LessonNineActivity.this, TestActivityLessonNineNLGR.class);
