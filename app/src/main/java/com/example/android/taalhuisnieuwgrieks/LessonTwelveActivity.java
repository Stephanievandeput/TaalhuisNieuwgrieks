...
public class LessonTwelveActivity extends AppCompatActivity {
    ...
    private void intentGRNL() {
        ...
        Intent overhoorIntent = new Intent(LessonTwelveActivity.this, TestActivityLessonTwelveGRNL.class);
    ...
    private void intentNLGR() {
        // Create a new intent to open the {@link NumbersActivity}
        Intent overhoorIntent = new Intent(LessonTwelveActivity.this, TestActivityLessonTwelveNLGR.class);
