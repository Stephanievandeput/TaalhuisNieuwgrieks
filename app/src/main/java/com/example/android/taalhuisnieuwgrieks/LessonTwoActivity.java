...
public class LessonTwoActivity extends AppCompatActivity {
    ...
    private void intentGRNL() {
        ...
        Intent overhoorIntent = new Intent(LessonTwoActivity.this, TestActivityLessonTwoGRNL.class);
    ...
    private void intentNLGR() {
        // Create a new intent to open the {@link NumbersActivity}
        Intent overhoorIntent = new Intent(LessonTwoActivity.this, TestActivityLessonTwoNLGR.class);
