...
public class LessonFifteenActivity extends AppCompatActivity {
    ...
    private void intentGRNL() {
        ...
        Intent overhoorIntent = new Intent(LessonFifteenActivity.this, TestActivityLessonFifteenGRNL.class);
    ...
    private void intentNLGR() {
        // Create a new intent to open the {@link NumbersActivity}
        Intent overhoorIntent = new Intent(LessonFifteenActivity.this, TestActivityLessonFifteenNLGR.class);
