...
public class LessonSevenActivity extends AppCompatActivity {
    ...
    private void intentGRNL() {
        ...
        Intent overhoorIntent = new Intent(LessonSevenActivity.this, TestActivityLessonSevenGRNL.class);
    ...
    private void intentNLGR() {
        // Create a new intent to open the {@link NumbersActivity}
        Intent overhoorIntent = new Intent(LessonSevenActivity.this, TestActivityLessonSevenNLGR.class);
